N = [50 54 55 60 70 80 100 125 150];  % Rozmiar macierzy
...
hold on
  ...
  %title('Porównanie błędów względnych rozwiązania układu równań danego macierzą "jedynkową"');
  legend('Matlab', 'Gauss bez el. głównego', 'Z el. głównym w kolumnie', 'Z el. głównym w macierzy');
  print -depscairo '-S450, 300' 'test_error_matrix1_matrices.eps'
hold off
